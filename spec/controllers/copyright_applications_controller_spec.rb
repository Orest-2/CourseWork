...
RSpec.describe Api::V1::CopyrightApplicationsController, type: :request do
    ...
    describe "GET copyright_applications_controller#accept/decline_copyright_applications" do
        it "should accept copyright application" do 
            ...
            application.copyright_application_tasks.create(title: "title1")
            application.copyright_application_tasks.create(title: "title2")
            get '/api/v1/copyright_applications/accept/1', params: nil, headers: headers
            expect(response.status).to eq(200)       
            json = JSON.parse(response.body)
        ...
        it "should decline copyright application" do 
            ...
            application.copyright_application_tasks.create(title: "title1")
            application.copyright_application_tasks.create(title: "title2")
            get '/api/v1/copyright_applications/decline/1', params: nil, headers: headers
            expect(response.status).to eq(200)       
            json = JSON.parse(response.body)
            expect(json["copyright_application"]["status"]).to eq(10)
            expect(json["copyright_application"]["executor_id"]).to eq(nil) 
            expect(json["copyright_application"]["director_id"]).to eq(10)
            expect(json["copyright_application"]["acceptor_id"]).to eq(secretary.id)
        end
    end
